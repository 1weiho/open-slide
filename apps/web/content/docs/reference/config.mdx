...
### Seed the UI language

The runtime UI language is picked in-app; `config.locale` only sets the
initial value and is the place to plug in a custom dictionary — see
