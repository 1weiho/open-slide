...
The scaffolder generates a workspace (abridged — see
[open-slide init](/docs/cli/init) for the full tree):
...
The skill scopes the deck (theme, aesthetic, page count, density, motion),
...
You can also edit text, typography, and colour directly from the inspector
property panel — see [Inspector](/docs/core-feature/inspector).
