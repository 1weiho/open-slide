...
Copies the latest skill definitions from your installed `@open-slide/react`
into the workspace under `.agents/skills/`, and refreshes the
`.claude/skills/` symlinks so Claude Code picks them up too.

Run this after upgrading `@open-slide/react` — that's how you pull in skill
...
.agents/
└── skills/
    └── <name>/        # canonical copy from @open-slide/react
.claude/
└── skills/
