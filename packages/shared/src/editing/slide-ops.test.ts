...
describe('reorderDefaultExportPagesInSource', () => {
  const withSatisfies = `import type { Page } from '@open-slide/react';
const A = () => null;
const B = () => null;
const C = () => null;
...
`;
  ...
  it('reorders a 3-element multi-line array', () => {
    ...
    expect(out).toContain("import type { Page } from '@open-slide/react';");
...
describe('removePageFromDefaultExportInSource', () => {
  const multiline = `import type { Page } from '@open-slide/react';
const A = () => null;
const B = () => null;
const C = () => null;
export default [
