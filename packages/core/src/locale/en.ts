...
export const en: Locale = {
  ...
  inspector: {
    ...
    commentsEmpty: 'No comments yet. Select an object and open Comment in the Format panel.',
  ...
  asset: {
    ...
    fontSearchTitle: 'Search Google Fonts',
    fontSearchPoweredByPrefix: 'Powered by ',
    fontSearchPlaceholder: 'Search font families…',
    fontSearchPreviewPlaceholder: 'Preview text',
    fontSearchErrorTitle: "Couldn't reach Google Fonts",
    fontSearchErrorBody: 'Check your connection and try again.',
    fontSearchNoResults: 'No fonts for "{query}"',
    fontSearchEmpty: 'No fonts available',
    fontSearchEmptyHintPrefix: 'Try a different family name, or browse the full catalog at ',
    fontSearchEmptyHintSuffix: '.',
    fontWeightLabel: 'Weight',
    fontPreviewSample: 'The quick brown fox jumps over the lazy dog 0123456789',
    ...
    toastFontDownloadFailed: 'Failed to download font',
  ...
  editablePptxToast: {
    ...
    preparing: 'Preparing editable PPTX ({current} of {total} pages)',
    processing: 'Converting page {current} of {total}',
    generating: 'Generating file ({current} of {total} pages)',
    generated: 'File generated, download started',
    cancelled: 'Export cancelled. No file was downloaded.',
    failed: 'Export failed. No file was downloaded.',
    showDiagnostics: 'Show diagnostics',
    hideDiagnostics: 'Hide diagnostics',
    downloadDiagnostics: 'Download JSON',
    errors: {
      one: '{count} error',
      other: '{count} errors',
    },
    ...
    qualitySummary: 'Editable structure',
    pages: {
      one: '{count} page',
      other: '{count} pages',
    },
    text: {
      one: '{count} text element',
      other: '{count} text elements',
    },
    tables: {
      one: '{count} table',
      other: '{count} tables',
    ...
    sourceImages: {
      one: '{count} source image',
      other: '{count} source images',
    },
    shapes: {
      one: '{count} shape',
      other: '{count} shapes',
    ...
    fontSubstitutions: {
      one: '{count} source uses a font substitution',
      other: '{count} sources use font substitutions',
    },
    vectorApproximations: {
      one: '{count} source uses a vector approximation',
      other: '{count} sources use vector approximations',
    },
    skippedGroups: {
      one: '{count} group remains separate',
      other: '{count} groups remain separate',
    },
    showQualityDetails: 'Show export details',
    hideQualityDetails: 'Hide export details',
    qualityDetailHeading: 'Per-page details',
    recipientFontsUnknown: 'Recipient font availability is unknown.',
    windowsNotVerified: 'Windows support is not verified.',
    sourceItems: 'source items',
    sourceObjects: 'source objects',
    editableObjects: 'editable objects',
    generatedParts: 'generated parts',
    groupContainers: 'group containers',
    vectorApproximationSources: 'vector approximation sources',
    fontSubstitutionSources: 'font substitution sources',
    fontDetails: 'Font resolutions',
    requestedFont: 'Requested',
    resolvedFont: 'Resolved',
    fontSubstitutionImpact: 'Text may reflow with the resolved font.',
    fontUnsafeImpact: 'Text may reflow or overflow with this font.',
    fontPreservedImpact: 'The requested font was preserved for this source.',
    fontSubstitutionSuggestion:
      'Install the requested font on the recipient device when exact layout matters.',
    reason: 'Reason',
    impact: 'Impact',
    diagnosticErrorImpact: 'Export stopped; no PowerPoint file was downloaded.',
    diagnosticWarningImpact: 'Export continues, but this area may need review.',
    groupSkippedImpact: 'The source stays editable, but its group cannot be operated as one unit.',
    vectorApproximationImpact:
      'Editable vector parts retain the appearance; soft edges or colour steps may vary in PowerPoint.',
    page: 'Page {page}',
    deck: 'Deck',
    code: 'Code',
    source: 'Source',
