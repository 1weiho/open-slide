...
export const zhTW: Locale = {
  ...
  themes: {
    ...
    importDialogTitle: '匯入主題',
    importDialogDescription:
      '貼上已部署的 open-slide 網站 URL、themes/index.json，或主題的 .md 檔案。',
    importUrlPlaceholder: 'https://example.com',
    importWarning:
      '主題的 demo 檔案是會在你的開發伺服器與 build 中執行的程式碼。請只從你信任的來源匯入。',
    importAction: '匯入',
    importing: '匯入中…',
    importMultipleFound: '此來源包含 {count} 個主題，請選擇要匯入的主題。',
    importSuccess: '已匯入 {ids}',
    importRenamed: '為避免重名已重新命名：{renames}',
    importFailed: '匯入失敗：{msg}',
    copyUrl: '複製主題 URL',
    copyUrlSuccess: '已複製主題 URL',
    copyUrlFailed: '複製 URL 失敗',
    themeActions: '主題操作',
    deleteEyebrow: '危險操作',
    deleteDialogTitle: '刪除主題？',
    deleteDialogDescription: '這會永久從磁碟移除 {name} 及其檔案，此操作無法復原。',
