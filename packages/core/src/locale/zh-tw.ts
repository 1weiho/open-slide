...
export const zhTW: Locale = {
  ...
  inspector: {
    ...
    editMode: '編輯',
    previewMode: '預覽',
    closeFormatPanel: '關閉格式面板',
    editText: '在投影片上編輯',
    emptySelectionTitle: '選取一個物件',
    emptySelectionHint: '按一下物件即可調整格式。按兩下文字即可編輯。',
    textSelectionHint: '格式將套用至選取的文字。',
    elementText: '文字',
    elementImage: '圖片',
    elementShape: '形狀',
    sourceSection: '原始碼',
    ...
    alignMiddle: '垂直置中',
    alignBottom: '靠下對齊',
    distributeLabel: '平均分佈',
    distributeHorizontal: '水平平均分佈',
    distributeVertical: '垂直平均分佈',
    layerLabel: '圖層',
    bringToFront: '移到最上層',
    bringForward: '上移一層',
    sendBackward: '下移一層',
    ...
    commentsEmpty: '還沒有留言。選取物件後，在格式面板中開啟「留言」。',
  ...
  asset: {
    ...
    logoVariantLight: '淺色',
    logoVariantDark: '深色',
    fontSearchTitle: '搜尋 Google Fonts',
    fontSearchPoweredByPrefix: '由 ',
    fontSearchPlaceholder: '搜尋字型家族…',
    fontSearchPreviewPlaceholder: '預覽文字',
    fontSearchErrorTitle: '無法連線至 Google Fonts',
    fontSearchErrorBody: '請檢查網路連線後重試。',
    fontSearchNoResults: '找不到「{query}」的字型',
    fontSearchEmpty: '沒有可用的字型',
    fontSearchEmptyHintPrefix: '試試其他字型家族名稱,或在以下網站瀏覽完整目錄: ',
    fontSearchEmptyHintSuffix: '。',
    fontWeightLabel: '字重',
    fontPreviewSample: '永和九年 歲在癸丑 ABCabc 0123456789',
    ...
    toastFontDownloadFailed: '下載字型失敗',
  ...
  editablePptxToast: {
    title: '正在匯出可編輯 PPTX',
    preparing: '準備可編輯 PPTX（{current} / {total} 頁）',
    processing: '正在轉換第 {current} / {total} 頁',
    generating: '正在產生檔案（{current} / {total} 頁）',
    generated: '檔案已產生，已開始下載',
    cancelled: '匯出已取消，沒有下載檔案。',
    failed: '匯出失敗，沒有下載檔案。',
    showDiagnostics: '顯示診斷資訊',
    hideDiagnostics: '隱藏診斷資訊',
    downloadDiagnostics: '下載 JSON',
    errors: {
      one: '{count} 個錯誤',
      other: '{count} 個錯誤',
    },
    ...
    fontSubstitutions: {
      one: '{count} 個來源使用了替代字體',
      other: '{count} 個來源使用了替代字體',
    },
    vectorApproximations: {
      one: '{count} 個來源使用了向量近似',
      other: '{count} 個來源使用了向量近似',
    },
    skippedGroups: {
      one: '{count} 個群組維持為獨立物件',
      other: '{count} 個群組維持為獨立物件',
    },
    showQualityDetails: '顯示匯出詳情',
    hideQualityDetails: '隱藏匯出詳情',
    qualityDetailHeading: '按頁查看詳情',
    recipientFontsUnknown: '收件者裝置的字體環境未知。',
    windowsNotVerified: 'Windows 尚未驗證。',
    sourceItems: '來源項目',
    sourceObjects: '來源物件',
    editableObjects: '可編輯物件',
    generatedParts: '產生的部件',
    groupContainers: '群組容器',
    vectorApproximationSources: '向量近似來源',
    fontSubstitutionSources: '替代字體來源',
    fontDetails: '字體解析',
    requestedFont: '指定字體',
    resolvedFont: '解析後字體',
    fontSubstitutionImpact: '收件者使用解析後字體時，文字可能重新換行。',
    fontUnsafeImpact: '使用此字體時，文字可能重新換行或溢出。',
    fontPreservedImpact: '此來源保留了指定字體。',
    fontSubstitutionSuggestion: '若需要精確版面，請在收件者裝置上安裝指定字體。',
    reason: '理由',
    impact: '影響',
    diagnosticErrorImpact: '匯出已停止；沒有下載 PowerPoint 檔案。',
    diagnosticWarningImpact: '匯出繼續，但這部分可能需要檢查。',
    groupSkippedImpact: '來源內容仍可編輯，但該群組無法作為一個整體操作。',
    vectorApproximationImpact:
      '可編輯向量部件保留外觀；PowerPoint 中的柔和邊緣或色階可能略有差異。',
    page: '第 {page} 頁',
    deck: '簡報',
    code: '代碼',
    source: '來源',
  ...
  notesDrawer: {
    ...
    placeholder: '為這一頁撰寫演講備忘（支援 Markdown）…',
    statusSaving: '儲存中…',
    statusSaved: '已儲存',
