...
export const zhTW: Locale = {
  ...
  inspector: {
    ...
    smartGuides: '智慧對齊線',
    clearLayout: '清除版面配置',
    clearLayoutTransform: '清除位置和旋轉',
    clearLayoutAll: '清除全部版面配置',
    clearLayoutHint: '移除拖曳產生的偏移和旋轉。按住 Alt 點按可一併移除編輯器設定的尺寸和圖層。',
    clearLayoutAltOnly: '沒有可清除的偏移或旋轉。可使用選單清除編輯器設定的尺寸和圖層。',
    clearLayoutNothing: '沒有可清除的內容：沒有編輯器設定的偏移、旋轉、尺寸或圖層。',
    clearLayoutOptions: '清除版面配置選項',
    clearLayoutKeptPosition: '已保留 position: relative，因為內部元素以它為定位基準。',
    selectParent: '選取父層',
    visualEditorHint:
