...
export const zhTW: Locale = {
  ...
  inspector: {
    ...
    elementShape: '形狀',
    sourceSection: '原始碼',
    copySourceLocation: '複製原始碼位置',
    copyForAgent: '複製給 agent',
    sourceLocationCopied: '已複製原始碼位置',
    agentSnippetCopied: '已複製位置與元素給 agent',
    clipboardFailed: '無法複製到剪貼簿',
    sourceLocationMore: '+{count}',
    untracedTitle: '不在這張 slide 的原始碼中',
    untracedHint: '這個 <{tag}> 來自版面或匯入的元件，而不是 {file}。請選取寫在這個檔案裡的元素。',
    sharedInstancesHint: '這一行渲染了 {count} 次。樣式修改會套用到每一個副本。',
    rotateHandle: '旋轉元素',
