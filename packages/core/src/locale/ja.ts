...
export const ja: Locale = {
  ...
  asset: {
    ...
    logoVariantDark: 'ダーク',
    fontSearchTitle: 'Google Fonts を検索',
    fontSearchPoweredByPrefix: 'Powered by ',
    fontSearchPlaceholder: 'フォントファミリーで検索…',
    fontSearchPreviewPlaceholder: 'プレビューテキスト',
    fontSearchErrorTitle: 'Google Fonts に接続できません',
    fontSearchErrorBody: '接続を確認して再試行してください。',
    fontSearchNoResults: '「{query}」のフォントは見つかりません',
    fontSearchEmpty: '利用可能なフォントはありません',
    fontSearchEmptyHintPrefix:
      '別のファミリー名を試すか、次のサイトでカタログ全体を閲覧してください: ',
    fontSearchEmptyHintSuffix: '。',
    fontWeightLabel: 'ウェイト',
    fontPreviewSample: 'いろはにほへと 永遠 ABCabc 0123456789',
    ...
    toastFontDownloadFailed: 'フォントのダウンロードに失敗しました',
  ...
  thumbnailRail: {
    ...
    addPage: 'ページを追加',
    addPageAfter: '後にページを追加',
    toastAdded: 'ページ {n} を追加しました',
    toastAddFailed: 'ページを追加できませんでした',
    duplicatePage: '複製',
    deletePage: '削除',
