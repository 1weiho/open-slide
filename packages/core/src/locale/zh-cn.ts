...
export const zhCN: Locale = {
  ...
  inspector: {
    ...
    smartGuides: '智能参考线',
    clearLayout: '清除布局',
    clearLayoutTransform: '清除位置和旋转',
    clearLayoutAll: '清除全部布局',
    clearLayoutHint: '移除拖动产生的偏移和旋转。按住 Alt 点击可同时移除编辑器设置的尺寸和图层。',
    clearLayoutAltOnly: '没有可清除的偏移或旋转。可使用菜单清除编辑器设置的尺寸和图层。',
    clearLayoutNothing: '没有可清除的内容：没有编辑器设置的偏移、旋转、尺寸或图层。',
    clearLayoutOptions: '清除布局选项',
    clearLayoutKeptPosition: '已保留 position: relative，因为内部元素以它为定位基准。',
    selectParent: '选择父级',
    visualEditorHint:
