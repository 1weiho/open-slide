...
export const zhCN: Locale = {
  ...
  themes: {
    ...
    importDialogDescription:
      '粘贴已部署的 open-slide 网站 URL、themes/index.json，或主题的 .md 文件。',
    importUrlPlaceholder: 'https://example.com',
    importWarning:
      '主题的 demo 文件是会在你的开发服务器与 build 中执行的代码。请只从你信任的来源导入。',
    importAction: '导入',
    importing: '导入中…',
    importMultipleFound: '此来源包含 {count} 个主题，请选择要导入的主题。',
    importSuccess: '已导入 {ids}',
    importRenamed: '为避免重名已重命名：{renames}',
    importFailed: '导入失败：{msg}',
    copyUrl: '复制主题 URL',
    copyUrlSuccess: '已复制主题 URL',
    copyUrlFailed: '复制 URL 失败',
    themeActions: '主题操作',
    deleteEyebrow: '危险操作',
    deleteDialogTitle: '删除主题？',
    deleteDialogDescription: '这会永久从磁盘移除 {name} 及其文件，此操作无法撤销。',
