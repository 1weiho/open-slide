...
export const zhCN: Locale = {
  ...
  inspector: {
    ...
    elementShape: '形状',
    sourceSection: '源代码',
    copySourceLocation: '复制源代码位置',
    copyForAgent: '复制给 agent',
    sourceLocationCopied: '已复制源代码位置',
    agentSnippetCopied: '已复制位置和元素给 agent',
    clipboardFailed: '无法复制到剪贴板',
    sourceLocationMore: '+{count}',
    untracedTitle: '不在这张 slide 的源代码中',
    untracedHint: '这个 <{tag}> 来自版面或导入的组件，而不是 {file}。请选取写在这个文件里的元素。',
    sharedInstancesHint: '这一行渲染了 {count} 次。样式修改会套用到每一个副本。',
    rotateHandle: '旋转元素',
